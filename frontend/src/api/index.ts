...
export const publicAPI = {
  ...
  getQuickShootVideos: (qsId: string) =>
    api.get(`/public/quick-shoots/${qsId}/videos`),
  ...
  getContentSection: (section: string) =>
    api.get(`/public/content/${section}`),
  getBrand: () => api.get('/public/brand'),
  getStats: () => api.get('/public/stats'),
  submitEnquiry: (data: Record<string, string>) =>
...
export const adminAPI = {
  ...
  uploadHomeVideo: (data: FormData) =>
    api.post('/admin/home-videos', data),
  updateHomeVideo: (
    id: string,
    data: FormData | Record<string, unknown>
  ) => api.put(`/admin/home-videos/${id}`, data),
  deleteHomeVideo: (id: string) =>
    api.delete(`/admin/home-videos/${id}`),
  ...
  // Service Videos
  getServiceVideos: (serviceId: string) =>
    api.get(`/admin/services/${serviceId}/videos`),
  addServiceVideo: (serviceId: string, data: FormData) =>
    api.post(`/admin/services/${serviceId}/videos`, data),
  updateServiceVideo: (videoId: string, data: FormData) =>
    api.put(`/admin/services/videos/${videoId}`, data),
  deleteServiceVideo: (videoId: string) =>
    api.delete(`/admin/services/videos/${videoId}`),
  ...
  createQuickShoot: (data: FormData) =>
    api.post('/admin/quick-shoots', data),
  updateQuickShoot: (id: string, data: FormData) =>
    api.put(`/admin/quick-shoots/${id}`, data),
  deleteQuickShoot: (id: string) =>
    api.delete(`/admin/quick-shoots/${id}`),

  // Quick Shoot Videos
  getQuickShootVideos: (qsId: string) =>
    api.get(`/admin/quick-shoots/${qsId}/videos`),
  addQuickShootVideo: (qsId: string, data: FormData) =>
    api.post(`/admin/quick-shoots/${qsId}/videos`, data),
  updateQuickShootVideo: (videoId: string, data: FormData) =>
    api.put(`/admin/quick-shoots/videos/${videoId}`, data),
  deleteQuickShootVideo: (videoId: string) =>
    api.delete(`/admin/quick-shoots/videos/${videoId}`),

  // Partners
  getPartners: () => api.get('/admin/partners'),
  createPartner: (data: FormData) =>
    api.post('/admin/partners', data),
  updatePartner: (id: string, data: FormData) =>
  ...
  updateClient: (id: string, data: FormData) =>
  ...
  updateContent: (
    section: string,
    data: Record<string, unknown>
  ) => api.put(`/admin/content/${section}`, data),

  // Stats
  updateStats: (data: Record<string, unknown>) =>
    api.put('/admin/stats', data),

  // Brand
  getBrand: () => api.get('/admin/brand'),
  updateBrand: (data: FormData) =>
    api.put('/admin/brand', data),

  // Partner Accounts
  getPartnerAccounts: () =>
    api.get('/admin/partner-accounts'),
  createPartnerAccount: (data: Record<string, string>) =>
    api.post('/admin/partner-accounts', data),
  updatePartnerAccount: (
    id: string,
    data: Record<string, unknown>
  ) => api.put(`/admin/partner-accounts/${id}`, data),
  deletePartnerAccount: (id: string) =>
    api.delete(`/admin/partner-accounts/${id}`),
};

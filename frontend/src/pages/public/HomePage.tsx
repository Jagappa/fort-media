...
const FadeIn = ({ children, delay = 0, className = '' }: { children: React.ReactNode; delay?: number; className?: string }) => {
  ...
  return (
    <motion.div
      ...
      animate={inView ? { opacity: 1, y: 0 } : {}}
      transition={{ duration: .6, delay, ease: [.16, 1, .3, 1] }}
    >
      {children}
    </motion.div>
  );
...
const PairReveal = ({ children, index }: { children: React.ReactNode; index: number }) => {
  ...
  return (
    <motion.div
      ...
      initial={{ opacity: 0, y: 50 }}
      animate={inView ? { opacity: 1, y: 0 } : {}}
      transition={{ duration: .6, delay: pairDelay, ease: [.16, 1, .3, 1] }}
    >
      {children}
    </motion.div>
  );
...
export default function HomePage() {
  ...
  // Convert backend media paths to Render backend URLs.
  const logoUrl = brand.logo
    ? mediaUrl(brand.logo)
    : '/fort-media-logo.png';

  const showHeroText =
    heroContent.showHeroText !== 'false' &&
    heroContent.showHeroText !== false;
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      toast.success(
        lang === 'kn'
          ? 'ವಿಚಾರಣೆ ಯಶಸ್ವಿಯಾಗಿ ಸಲ್ಲಿಸಲಾಗಿದೆ!'
  ...
  const whyItems = [
    {
      ...
      desc: 'We turn ideas into content people remember.'
    },
    {
      num: '02',
    ...
    },
    {
      ...
      desc: 'Every shoot is planned to create strong visual impact.'
    },
    {
      num: '04',
      title: 'RESULT-FOCUSED MARKETING',
      desc: 'Creative work should create business results.'
    },
    {
      num: '05',
      title: 'BRAND-FOCUSED STRATEGY',
      desc: 'Everything we do builds toward a stronger brand.'
    },
    {
      num: '06',
      title: 'ONE CREATIVE PARTNER',
      desc: 'Marketing, social media, production, branding, and websites under one roof.'
    },
  ];
  ...
  const processSteps = [
    {
      num: '01',
      title: 'DISCOVER',
      desc: 'Understand the business, brand, audience, and goals.'
    },
    {
      num: '02',
      title: 'STRATEGIZE',
      desc: 'Build the creative and marketing direction.'
    },
    {
      num: '03',
      title: 'CREATE',
      desc: 'Produce the content, campaigns, websites, and brand assets.'
    },
    {
      num: '04',
      title: 'GROW',
      desc: 'Launch, analyze, optimize, and improve.'
    },
  ];
  ...
  return (
    <div style={{ background: 'var(--bg)' }}>
      ...
      <a href="#portfolio" className="pm-skip-link">
        Skip to content
      </a>
      ...
      <nav
        style={{
          ...
          right: 0,
          zIndex: 1000,
          height: navScrolled ? 'var(--nav-h-sm)' : 'var(--nav-h)',
          display: 'flex',
          alignItems: 'center',
          justifyContent: 'space-between',
          padding: '0 var(--side-pad)',
          background: navScrolled ? 'rgba(10,10,10,.94)' : 'transparent',
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                fontWeight: 600,
                cursor: 'pointer',
                background: lang === 'kn' ? 'var(--red)' : 'transparent',
                color: lang === 'kn' ? '#fff' : 'var(--gray)',
      ...
      >
        {homeVideo && homeVideo.videoFile && (
          <video
            ...
            style={{
              ...
              height: '100%',
              objectFit: 'cover',
              opacity: showHeroText ? .3 : .7
            }}
          >
            <source src={mediaUrl(homeVideo.videoFile)} />
          </video>
        )}
        ...
        {showHeroText && (
          ...
          >
            ...
            <div style={{ overflow: 'hidden' }}>
              ...
              >
                <span style={{ color: 'var(--red)' }}>
                  {heroContent.headingAccent || 'WE BUILD THEM.'}
                </span>
              </motion.h1>
            </div>
            ...
            >
              {heroContent.subtext ||
                'Fort Media helps businesses build attention and create content that demands to be seen.'}
            </motion.p>
            ...
            >
              <Magnetic enabled={premium}>
                <a href="#contact" className="btn-primary">
                  <span>
                    {heroContent.ctaPrimary || "LET'S BUILD YOUR BRAND"}
                  </span>
                </a>
              </Magnetic>
              ...
              <Magnetic enabled={premium}>
                <a href="#portfolio" className="btn-secondary">
                  <span>
                    {heroContent.ctaSecondary || 'VIEW OUR WORK'}
                  </span>
                </a>
              </Magnetic>
            </motion.div>
      ...
      <div className="layer-stack">
        ...
        <LayerPanel
          ...
          zIndex={10}
          background="var(--bg)"
          enabled={layerScroll && OUR_WORK_IS_BASE_LAYER}
        >
          <Section className="grid-bg">
            <FadeIn>
              <div className="section-label">FORT MEDIA</div>
            </FadeIn>

            <FadeIn delay={.1}>
              <h2 className="section-title">
                <SmokeTitle>
                  {lang === 'kn' ? 'ನಮ್ಮ ಕೆಲಸ' : 'OUR WORK'}
                </SmokeTitle>
              </h2>
            </FadeIn>
            ...
            <FadeIn delay={.2}>
              <p className="section-subtitle">
                Click on a service to explore our work.
              </p>
            </FadeIn>
                      ...
                      <div className="pm-card pm-work-card">
                        {svc.mainImage ? (
                          <img
                            ...
                            src={mediaUrl(svc.mainImage)}
                            alt={t(svc.name)}
                            loading="lazy"
                          />
                        ) : (
                          <span className="pm-work-empty">
                            ▶ EXPLORE
                          </span>
                        )}
                      </div>
        ...
        >
          ...
          >
            ...
            >
              {aboutContent.text ||
                'Fort Media is a creative powerhouse that combines marketing, storytelling, production, social media, advertising, branding, and technology into one studio.'}
            </p>
        ...
        >
          <Section className="grid-bg">
            <FadeIn>
              <div className="section-label">
                {whatWeDoContent.label || 'OUR EXPERTISE'}
              </div>
            </FadeIn>
        ...
        >
          <Section>
            <div
              style={{
                background: 'var(--surface)',
                margin: 'calc(-1 * var(--section-pad)) calc(-1 * var(--side-pad))',
                padding: 'var(--section-pad) var(--side-pad)'
              }}
            >
              <FadeIn>
                <div className="section-label">
                  {qsContent.label || 'QUICK SHOOTS'}
                </div>
              </FadeIn>
              ...
              <FadeIn delay={.2}>
                ...
                >
                  {qsContent.subtext ||
                    'Click a shoot type to watch our work.'}
                </p>
              </FadeIn>
              ...
              >
                {quickShoots.map((qs: any, i: number) => (
                  ...
                  >
                    <Link
                      to={`/quick-shoots/${qs._id}`}
                      aria-label={`${t(qs.name)} — watch our work`}
                    >
                      <div
                        className="pm-card pm-shoot"
                        style={{
                          padding: 30,
                          cursor: 'pointer',
                          height: '100%'
      ...
      <Section id="process">
        ...
        >
          ...
          <FadeIn delay={.1}>
            <h2 className="section-title">
              <SmokeTitle>OUR PROCESS</SmokeTitle>
            </h2>
          </FadeIn>
      ...
      {/* ═══ CLIENTS ═══ */}
      <Section id="clients" className="grid-bg">
        <div style={{ textAlign: 'center' }}>
          ...
          <FadeIn delay={.1}>
            <h2 className="section-title">
              <SmokeTitle>TRUSTED BY BRANDS</SmokeTitle>
            </h2>
          </FadeIn>
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    fontSize: 12,
                    color: 'var(--gray-dark)',
                    backgroundImage: cl?.logo
                      ? `url(${mediaUrl(cl.logo)})`
                      : 'none',
      ...
      <Section id="testimonials">
        ...
        >
          ...
          <FadeIn delay={.1}>
            <h2 className="section-title">
              <SmokeTitle>TESTIMONIALS</SmokeTitle>
            </h2>
          </FadeIn>
              ...
              : [
                  {
                    ...
                    company: 'Company',
                    testimonial: {
                      en: 'Add testimonials from admin.'
                    },
                    rating: 5
                  }
                ]
                  ...
                  >
                    <div
                      style={{
                        ...
                        backgroundImage: test.profileImage
                          ? `url(${mediaUrl(test.profileImage)})`
                          : 'none',
        ...
        <FadeIn delay={.2}>
          ...
          >
            {contactContent.subtext ||
              "Whether you need digital marketing, social media management, an ad shoot — let's talk."}
          </p>
        </FadeIn>
        ...
        >
          <FadeIn delay={.3}>
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    ...
                    <a
                      href={`https://wa.me/${(brand.whatsapp || brand.phone || '').replace(/[^0-9]/g, '')}`}
                      target="_blank"
                      rel="noopener"
                      style={{
                        fontSize: 11,
              ...
              {/* Email */}
              <a
                href={`mailto:${brand.email || 'hello@fortmedia.in'}`}
                style={{
                  display: 'flex',
                  alignItems: 'flex-start',
                  gap: 14
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ fontSize: 15 }}>
                    {brand.email || 'hello@fortmedia.in'}
                  </div>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ fontSize: 15 }}>
                    {brand.location || 'Your City, India'}
                  </div>
                </div>
              </div>
              ...
              {/* Instagram */}
              <a
                href={`https://instagram.com/${(brand.instagram || 'fortmedia').replace('@', '')}`}
                target="_blank"
                rel="noopener"
                style={{
                  display: 'flex',
      ...
      >
        ...
        >
          ...
          >
            ...
            {brand.facebook && (
              <a
                href={
                  brand.facebook.startsWith('http')
                    ? brand.facebook
                    : `https://facebook.com/${brand.facebook}`
                }
                target="_blank"
                rel="noopener"
                title="Facebook"
            ...
            {brand.youtube && (
              <a
                href={
                  brand.youtube.startsWith('http')
                    ? brand.youtube
                    : `https://youtube.com/${brand.youtube}`
                }
                target="_blank"
                rel="noopener"
                title="YouTube"
              ...
              <a
                href={
                  brand.linkedin.startsWith('http')
                    ? brand.linkedin
                    : `https://linkedin.com/in/${brand.linkedin}`
                }
                target="_blank"
                rel="noopener"
                title="LinkedIn"
        ...
        >
          ...
          >
            © FORT MEDIA — ALL RIGHTS RESERVED.
          </span>
        </div>
      </footer>
